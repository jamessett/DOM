togglePic = true;
let init = function(){
    //.createElement() creates a new element to be used to the HTML file. This method accepts a parameter of the element's name you wish to add.
    //To use this method, we need to first create a variable that represent the element we wish to add.
